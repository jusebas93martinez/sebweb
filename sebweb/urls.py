...
urlpatterns = [
    ...
    path('loadfile_poldoble_ex/', views.cargar_archivos_pol_cerrada_ex, name='cargar_archivos_poligonal_ex'),
    ...
    path('pol_cerrada_ex/', views.procesar_pol_ex, name='procesar_pol_ex'),
    ...
    path('grafica3/', views.procesar_archivos_pol_cerrada_ex,name='grafica3'),
